...
$(function () {
    ...
    $.ajax({
        type: "GET",//请求类型
        url: projectName + "/app/getFlatForm",//请求的url
    ...
    $.ajax({
        type: "GET",//请求类型
        url: projectName+"/app/getCategoryByParentId",//请求的url
        data: {pid: 0},//请求参数
        dataType: "json",//ajax接口（请求url）返回的数据类型
        success: function (data) {//data：返回数据（json对象）
            $("#categoryLevel1").html("");
    ...
    $("#back").on("click", function () {
        window.location.href = projectName+"/app/getAppListPage";
    });
    ...
    $("#APKName").bind("blur", function () {
        ...
        $.ajax({
            type: "GET",//请求类型
            url: projectName + "/app/apkNameExist",//请求的url
